...
export function Career() {
  ...
  const totalCompanies = 1 // DEV Community, Hashnode, TCS, IBM
  const totalJobs = 1 // 3 professional roles (excluding education)
  const totalYears = "1 Year and 6 Months " // Approximate years of professional experience
